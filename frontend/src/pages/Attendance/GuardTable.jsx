// GuardTable.jsx
// UI-only table for Guard Attendance (Shift Only Sheet – PDF Spec)
  ...
  return (
    <div className="bg-white">
      ...
      <div className="px-4 py-3 bg-gray-100 border border-gray-400 border-b-0">
        <h2 className="text-lg font-bold text-gray-800">Guard Attendance Records</h2>
      </div>
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 text-center text-xs font-bold text-gray-700 border border-gray-400 bg-gray-100">Shift</th>
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i}>
                ...
                <td className="px-4 py-2 text-center text-gray-700 border border-gray-400">{r.shift || '-'}</td>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan="9" className="px-4 py-4 text-center text-gray-500 border border-gray-400">
                  No guard attendance available
                </td>
              </tr>
            )}
          </tbody>
