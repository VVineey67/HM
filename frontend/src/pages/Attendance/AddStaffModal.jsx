...
const AddStaffModal = ({ isOpen, onClose, onSave, staffNames }) => {
  ...
  const calculateWorkingHours = () => {
    const inTime = formData.inTime.split(':');
    const outTime = formData.outTime.split(':');
    ...
    setFormData(prev => ({
      ...prev,
      workingHrs: `${hours}Hrs ${minutes}Min`
    }));
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full p-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
              />
            </div>
            ...
            <div className="relative" ref={nameDropdownRef}>
              <label className="text-xs font-bold text-gray-500 mb-1.5 block">
                Name * <span className="text-blue-500 font-normal">(Type or select)</span>
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full p-2.5 pr-10 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                />
                <button
                  type="button"
              ...
              {showNameDropdown && filteredNames.length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg max-h-48 overflow-y-auto">
                  ...
                  {formData.name && !staffNames.includes(formData.name) && (
            ...
            <div className="relative" ref={designationDropdownRef}>
              <label className="text-xs font-bold text-gray-500 mb-1.5 block">
                Designation * <span className="text-blue-500 font-normal">(Type or select)</span>
              </label>
              <div className="relative">
                <input
            ...
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-600"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all resize-none"
              />
            </div>
          </div>
          ...
          <div className="sticky bottom-0 bg-white pt-4 border-t border-gray-200 flex justify-end gap-3">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl font-bold transition-all shadow-md hover:shadow-xl"
            >
              Add Record
            </button>
          </div>
